...
import type { GameDTO, UpdateGameRequest, Difficulte, TypeJeu, ModeJeu } from '@/api/types';
import {
  validateRequired,
  validateMaxLength,
  validateInteger,
        ...
        <form onSubmit={handleSubmit} className="p-8" noValidate>
          ...
          <section className="mb-8">
            ...
            <div className="space-y-5">
              <div>
                <label htmlFor="game-titre" className={labelClass}>Titre du jeu *</label>
                <input
                  id="game-titre"
                  type="text"
              ...
              <div>
                <label htmlFor="game-description" className={labelClass}>Description *</label>
                <textarea
                  id="game-description"
          ...
          <section className="mb-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 mb-5">
              <div>
                <label htmlFor="game-typeJeu" className={labelClass}>Type de jeu *</label>
                <select
                  id="game-typeJeu"
              ...
              <div>
                <label htmlFor="game-modeJeu" className={labelClass}>Mode de jeu *</label>
                <select
                  id="game-modeJeu"
              ...
              <div>
                <label htmlFor="game-difficulte" className={labelClass}>Difficulté *</label>
                <select
                  id="game-difficulte"
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-5">
              ...
              <div>
                <label htmlFor="game-dureeMinutes" className={labelClass}>Durée (minutes) *</label>
                <input
                  id="game-dureeMinutes"
                  type="number"
